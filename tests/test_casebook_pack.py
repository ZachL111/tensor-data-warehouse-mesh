"""Regression checks for the tensor-data-warehouse-mesh casebook."""
...
from casebook.harness import assert_expected, tensor_data_warehouse_mesh_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(tensor_data_warehouse_mesh_summary(), assert_expected())
