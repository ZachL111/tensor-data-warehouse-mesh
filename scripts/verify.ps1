...
powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-tensor-data-warehouse-detail.ps1
...
powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-tensor-data-warehouse-properties.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-tensor-data-warehouse-golden.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-tensor_data_warehouse_mesh-casebook.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }
